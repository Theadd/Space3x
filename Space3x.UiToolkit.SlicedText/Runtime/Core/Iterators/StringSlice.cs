...
namespace Space3x.UiToolkit.SlicedText.Iterators
{
    ...
    /// See Unity's built-in <see cref="UnityEditor.Search.StringView"/> for an equivalent implementation.
    /// </summary>
    /// <seealso cref="UnityEditor.Search.StringView"/>
    ...
    public struct StringSlice : ICharIterator
    {
        ...
        public StringSlice(ref StringSlice other)
        {
            Text = other.Text;
            Start = other.Start;
            End = other.End;
        ...
        public string ToStringLine()
        {
            ...
            return text.Substring(start, length - (text[End] == '\n' ? 1 : 0));
        }
