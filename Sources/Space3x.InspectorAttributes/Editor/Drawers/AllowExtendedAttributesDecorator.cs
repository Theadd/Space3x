...
#else
            if ((Application.isPlaying && (GhostContainer.panel is IPanel containerPanel && containerPanel.contextType == ContextType.Player)) || Field is BindablePropertyField) return;
#endif
