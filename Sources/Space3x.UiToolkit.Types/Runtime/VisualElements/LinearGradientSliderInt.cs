...
{
    /// <summary>
    /// Draws a two-color linear gradient over the track of a slider field for integer values.
    /// </summary>
    [UxmlElement]
    public partial class LinearGradientSliderInt : SliderInt, IGradientSlider
    {
        ...
        public LinearGradientSliderInt() : base()
        {
