...
namespace Space3x.InspectorAttributes.Editor.Drawers
{
    ...
    public class AllowExtendedAttributesDecorator : Decorator<AutoDecorator, AllowExtendedAttributes>
    {
        ...
        // TODO: remove
        public int OnUpdateIgnoredCallsCounter { get; set; }
        ...
        {
            // Debug.LogError($"<color=#FF007FFF>{this} <b>OnUpdate</b> Hash: {this.GetHashCode()}, IsRuntimeUI: {Property.GetController().IsRuntimeUI}");
            if (!m_IsReady)
            {
                m_IsReady = true;
            ...
            else OnUpdateIgnoredCallsCounter++;
        }
