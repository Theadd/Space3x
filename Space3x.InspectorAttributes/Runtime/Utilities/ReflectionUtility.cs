...
namespace Space3x.InspectorAttributes
{
	public static class ReflectionUtility
    {
		...
		{
			/* TODO: If property != property.GetParentProperty().FindPropertyRelative(memberName)
             *       AND that relative property is a method accepting IPropertyNode as parameter,
             *       create that invokable with the relative property as parameter.
             * */
			var mInfo = GetValidMemberInfo(memberName, property, out object targetObject);
			return mInfo == null 
				? null 
