...
//             DebugLog.Info($"<color=#0000FFFF><b>[CREATE]</b> {this.GetType().Name}, Nº Ghosts: {numGhosts}, NullGhost: {GhostContainer == null}, NullContainer: {Container == null}, NullProperty: {Property == null}</color>");
...
//             // }
//             // /*else*/ if (Container != null /*&& Property != null*/)
//             // {
...
//                 DebugLog.Info($"    <color=#FFFF00FF>OnDetachGhostFromPanel: <b>[IGNORE]</b> {this.GetType().Name}, Removed: {m_Removed}</color>");
//                 return;
//             }
//             
//             DebugLog.Info($"    <color=#FFFF00FF>OnDetachGhostFromPanel: <b>[REMOVE]</b> {this.GetType().Name}, Removed: {m_Removed}</color>");
//             m_Removed = true;
//             OnReset(disposing: false);
//             GhostContainer = null;
//         }
